...
<div class="container" id="projectContent">
  ...
  <div class="row">
    ...
    <div class="col text-end" style="align-self: flex-end;">
      <span>총 ${projectCount[0]}건</span> <span>| 예정 ${projectCount[1]}건</span> <span>| 진행
        ${projectCount[4]}건</span>
    </div>
  </div>
  <hr>
  ...
  <div>
    <table class="table" style="width: 100%; table-layout: fixed;">
      <c:forEach var="project" items="${projectList.content}">
        <tr>
          <th rowspan="3"
            style="background-image: url(${project.proThumb}); background-size: 100% 100%;"></th>
          <th colspan="2">${project.proTitle}</th>
          ...
          <td colspan="2">
            <div class="progress">
              <div class="progress-bar" role="progressbar" style="width: ${project.proceed}%;"
                aria-valuenow="${project.proceed}" aria-valuemin="0" aria-valuemax="100">${project.proceed}%</div>
            </div>
          </td>
        </tr>
      </c:forEach>
