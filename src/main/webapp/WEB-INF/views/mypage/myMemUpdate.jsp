  ...
  <div class="content-center">
    <form action="" id="form">
      <table>
        <tr>
          <!-- 아이디 -->
          <td class="td1"><span style="color: orange">*</span> 아이디</td>
          <td class="td2">${member.memId}</td>
        </tr>
        <tr>
          <!-- 이름 -->
          <td class="td1"><span style="color: orange">*</span> 이름</td>
          <td class="td2"><input type="hidden" id="name" name="memName"
            value="${member.memName}">${member.memName}</td>
        </tr>
        <tr>
          <!-- 연락처 수정 -->
          <td class="td1"><span style="color: orange">*</span> 연락처</td>
          <td class="td2"><input type="text" id="mem-tel" name="memTel"
            value="${member.memTel}" required></td>
        </tr>

        <tr>
          <!-- 주소수정 -->
          <td class="td1">주소</td>
          <td class="td2"><label style="width: 91%;"> <input type="text"
              name="postalCode" id="postal-code" value="${address.postalCode}" readonly="readonly" />
          </label>
            <button type="button" onclick="sample4_execDaumPostcode();"
              style="padding-left: 9px; left: 0px;">주소 검색</button> <br> <input type="text"
            name="address1" id="address1" value="${address.address1}"> <br> <input
            type="text" name="address2" id="address2" value="${address.address2}"> <br>
            <input type="text" name="address3" id="address3" value="${address.address3}"> <br>
            <input type="text" name="address4" id="address4" readonly="readonly"
            value="${address.address4}"></td>
        </tr>

        <tr>
          <!-- 계좌수정 -->
          <td class="td1">계좌</td>
          <td class="td2">은행선택 : <!-- <input type="button" class="btn" id="bank" value="?">  -->
          ...
          </select> <br> <input type="text" id="account-name" name="accountName"
            value="${account.accountName}"> <br> <input type="text" id="account-number"
      ...
      <div class="content-center" role="group" aria-label="...">
        <a href="/main"> <input type="button" class="uploadButton" value="취소하기">
        </a> <a href="/main"> <input type="button" class="uploadButton" onclick="update(this)"
          value="저장하기">
        </a>
      </div>
    </form>
...
<script>
	function update(elClickedObj) {
		var memTel = document.getElementById('mem-tel');
